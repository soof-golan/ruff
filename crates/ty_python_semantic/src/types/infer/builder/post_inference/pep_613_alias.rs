...
pub(crate) fn check_implicit_alias<'db>(
    ...
    let is_bare_typing_self =
        value.is_name_expr() && matches!(value_ty, Type::SpecialForm(SpecialFormType::TypingSelf));
    if !is_bare_typing_self {
